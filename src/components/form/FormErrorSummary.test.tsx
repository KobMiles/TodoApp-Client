...
describe('DueQuickActions', () => {
  test('renders group and buttons', () => {
    ...
    expect(screen.getByRole('group', { name: /quick due presets/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /today/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /tomorrow/i })).toBeInTheDocument();
    expect(screen.getByRole('button', { name: /no due/i })).toBeInTheDocument();
  });
  ...
  test('fires callbacks', async () => {
    ...
    await user.click(screen.getByRole('button', { name: /no due/i }));
